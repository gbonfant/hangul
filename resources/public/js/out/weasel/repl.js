...
weasel.repl.process_message = (function (){var method_table__16555__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);
...
return (new cljs.core.MultiFn(cljs.core.symbol.call(null,"weasel.repl","process-message"),new cljs.core.Keyword(null,"op","op",-1882987955),new cljs.core.Keyword(null,"default","default",-1987822328),hierarchy__16559__auto__,method_table__16555__auto__,prefer_table__16556__auto__,method_cache__16557__auto__,cached_hierarchy__16558__auto__));
})();
...
repl_print.cljs$lang$applyTo = (function (arglist__29222){
...
while (G__29223__i < G__29223__a.length) {G__29223__a[G__29223__i] = arguments[G__29223__i + 0]; ++G__29223__i;}
  args = new cljs.core.IndexedSeq(G__29223__a,0);
} 
return console_print__delegate.call(this,args);};
console_print.cljs$lang$maxFixedArity = 0;
console_print.cljs$lang$applyTo = (function (arglist__29224){
...
var connect__delegate = function (repl_server_url,p__29228){
...
var print = cljs.core.get.call(null,map__29231__$1,new cljs.core.Keyword(null,"print","print",1299562414),new cljs.core.Keyword(null,"repl","repl",-35398667));
var on_close = cljs.core.get.call(null,map__29231__$1,new cljs.core.Keyword(null,"on-close","on-close",-761178394));
var on_error = cljs.core.get.call(null,map__29231__$1,new cljs.core.Keyword(null,"on-error","on-error",1728533530));
var on_open = cljs.core.get.call(null,map__29231__$1,new cljs.core.Keyword(null,"on-open","on-open",-1391088163));
var verbose = cljs.core.get.call(null,map__29231__$1,new cljs.core.Keyword(null,"verbose","verbose",1694226060),true);
var repl_connection = weasel.impls.websocket.websocket_connection.call(null);
cljs.core.swap_BANG_.call(null,weasel.repl.ws_connection,cljs.core.constantly.call(null,repl_connection));

clojure.browser.event.listen.call(null,repl_connection,new cljs.core.Keyword(null,"opened","opened",-1451743091),((function (repl_connection,map__29231,map__29231__$1,print,on_close,on_error,on_open,verbose){
return (function (evt){
...
});})(repl_connection,map__29231,map__29231__$1,print,on_close,on_error,on_open,verbose))
);

clojure.browser.event.listen.call(null,repl_connection,new cljs.core.Keyword(null,"message","message",-406056002),((function (repl_connection,map__29231,map__29231__$1,print,on_close,on_error,on_open,verbose){
return (function (evt){
var map__29232 = cljs.reader.read_string.call(null,evt.message);
...
var message = map__29232__$1;
var op = cljs.core.get.call(null,map__29232__$1,new cljs.core.Keyword(null,"op","op",-1882987955));
var response = cljs.core.pr_str.call(null,weasel.repl.process_message.call(null,message));
return clojure.browser.net.transmit.call(null,repl_connection,response);
});})(repl_connection,map__29231,map__29231__$1,print,on_close,on_error,on_open,verbose))
);

clojure.browser.event.listen.call(null,repl_connection,new cljs.core.Keyword(null,"closed","closed",-919675359),((function (repl_connection,map__29231,map__29231__$1,print,on_close,on_error,on_open,verbose){
return (function (evt){
...
clojure.browser.event.listen.call(null,repl_connection,new cljs.core.Keyword(null,"error","error",-978969032),((function (repl_connection,map__29231,map__29231__$1,print,on_close,on_error,on_open,verbose){
return (function (evt){
if(cljs.core.truth_(verbose)){
...
return cljs.core.into.call(null,cljs.core.PersistentHashSet.EMPTY,cljs.core.filter.call(null,((function (gntp,repl_connection,map__29231,map__29231__$1,print,on_close,on_error,on_open,verbose){
return (function (name){
return (goog.dependencies_.visited[(gntp[name])]);
});})(gntp,repl_connection,map__29231,map__29231__$1,print,on_close,on_error,on_open,verbose))
,cljs.core.js_keys.call(null,gntp)));
})();

goog.isProvided_ = ((function (repl_connection,map__29231,map__29231__$1,print,on_close,on_error,on_open,verbose){
return (function (_){
return false;
});})(repl_connection,map__29231,map__29231__$1,print,on_close,on_error,on_open,verbose))
;

goog.require = ((function (repl_connection,map__29231,map__29231__$1,print,on_close,on_error,on_open,verbose){
...
while (G__29233__i < G__29233__a.length) {G__29233__a[G__29233__i] = arguments[G__29233__i + 1]; ++G__29233__i;}
  p__29228 = new cljs.core.IndexedSeq(G__29233__a,0);
} 
return connect__delegate.call(this,repl_server_url,p__29228);};
connect.cljs$lang$maxFixedArity = 1;
connect.cljs$lang$applyTo = (function (arglist__29234){
var repl_server_url = cljs.core.first(arglist__29234);
var p__29228 = cljs.core.rest(arglist__29234);
return connect__delegate(repl_server_url,p__29228);
});
