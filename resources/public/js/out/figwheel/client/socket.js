...
figwheel.client.socket.open = (function open(p__30034){
var map__30036 = p__30034;
var map__30036__$1 = ((cljs.core.seq_QMARK_.call(null,map__30036))?cljs.core.apply.call(null,cljs.core.hash_map,map__30036):map__30036);
var opts = map__30036__$1;
var build_id = cljs.core.get.call(null,map__30036__$1,new cljs.core.Keyword(null,"build-id","build-id",1642831089));
var websocket_url = cljs.core.get.call(null,map__30036__$1,new cljs.core.Keyword(null,"websocket-url","websocket-url",-490444938));
var retried_count = cljs.core.get.call(null,map__30036__$1,new cljs.core.Keyword(null,"retried-count","retried-count",-2127867357));
var retry_count = cljs.core.get.call(null,map__30036__$1,new cljs.core.Keyword(null,"retry-count","retry-count",1936122875));
...
socket.onmessage = ((function (url,socket,WebSocket,temp__4124__auto__,map__30036,map__30036__$1,opts,build_id,websocket_url,retried_count,retry_count){
...
var and__15646__auto__ = cljs.core.map_QMARK_.call(null,msg);
if(and__15646__auto__){
var and__15646__auto____$1 = new cljs.core.Keyword(null,"msg-name","msg-name",-353709863).cljs$core$IFn$_invoke$arity$1(msg);
if(cljs.core.truth_(and__15646__auto____$1)){
var and__15646__auto____$2 = cljs.core.not_EQ_.call(null,new cljs.core.Keyword(null,"msg-name","msg-name",-353709863).cljs$core$IFn$_invoke$arity$1(msg),new cljs.core.Keyword(null,"ping","ping",-1670114784));
...
});})(url,socket,WebSocket,temp__4124__auto__,map__30036,map__30036__$1,opts,build_id,websocket_url,retried_count,retry_count))
;

socket.onopen = ((function (url,socket,WebSocket,temp__4124__auto__,map__30036,map__30036__$1,opts,build_id,websocket_url,retried_count,retry_count){
return (function (x){
...
socket.onclose = ((function (url,socket,WebSocket,temp__4124__auto__,map__30036,map__30036__$1,opts,build_id,websocket_url,retried_count,retry_count){
return (function (x){
var retried_count__$1 = (function (){var or__15658__auto__ = retried_count;
...
return setTimeout(((function (retried_count__$1,url,socket,WebSocket,temp__4124__auto__,map__30036,map__30036__$1,opts,build_id,websocket_url,retried_count,retry_count){
return (function (){
...
});})(retried_count__$1,url,socket,WebSocket,temp__4124__auto__,map__30036,map__30036__$1,opts,build_id,websocket_url,retried_count,retry_count))
,(function (){var x__15982__auto__ = (10000);
var y__15983__auto__ = ((2000) + ((500) * retried_count__$1));
...
socket.onerror = ((function (url,socket,WebSocket,temp__4124__auto__,map__30036,map__30036__$1,opts,build_id,websocket_url,retried_count,retry_count){
return (function (x){
